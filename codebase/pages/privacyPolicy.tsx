  ...
  return (
    <div>
      <Typography variant="body1">
        At mathRanks, accessible from https://mathranks.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        mathRanks and how we use it. If you have additional questions or require
        ...
        they shared and/or collect in mathRanks. This policy is not applicable
        ...
        Policy Generator from CookiePolicyGenerator.com. <br />
        Consent
        <br /> By using our website, you hereby consent to our Privacy Policy
        and agree to its terms. <br />
        Information we collect
        <br /> The personal information that you are asked to provide, and the
        ...
        you may choose to provide. When you register for an Account, we may ask
        for your contact information, including items such as name, company
        name, address, email address, and telephone number. <br />
        ...
        you emails Find and prevent fraud <br />
        Log Files
        <br /> mathRanks follows a standard procedure of using log files. These
        ...
        <br /> Like any other website, mathRanks uses 'cookies'. These cookies
        ...
        "Cookies" article from the Privacy Policy Generator. <br />
        Advertising Partners Privacy Policies
        <br /> You may consult this list to find the Privacy Policy for each of
        the advertising partners of mathRanks. Third-party ad servers or ad
        ...
        mathRanks, which are sent directly to users' browser. They automatically
        ...
        visit. Note that mathRanks has no access to or control over these
        cookies that are used by third-party advertisers. <br />
        Third Party Privacy Policies
        <br /> mathRanks's Privacy Policy does not apply to other advertisers or
        ...
        <br /> We would like to make sure you are fully aware of all of your
        ...
        <br /> Another part of our priority is adding protection for children
        while using the internet. We encourage parents and guardians to observe,
        participate in, and/or monitor and guide their online activity.
        mathRanks does not knowingly collect any Personal Identifiable
        Information from children under the age of 13. If you think that your
        child provided this kind of information on our website, we strongly
        encourage you to contact us immediately and we will do our best efforts
        to promptly remove such information from our records.
      </Typography>
      <Link href="https://docs.google.com/document/d/15LQWFaVK25sX-Le6WEhxL6uGaJ_DG3r7T1OhL8MfEwA/edit?usp=sharing">
        Cookie Policy
      </Link>
    </div>
  );
