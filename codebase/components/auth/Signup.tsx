                  ...
                  <div className=" px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div className="sm:flex sm:items-start">
                      <div className="mt-3 text-center sm:mt-0 w-full sm:text-left">
                        <div className="container mx-auto flex-1 flex flex-col items-center w-full justify-center">
                          <form
                          ...
                          >
                            ...
                            <div className="mb-6">
                              <input
                                ...
                                autoComplete="false"
                                id="username"
                                className="shadow appearance-none  rounded w-full py-2 px-3 text-white bg-black border-[0.5px] border-borderCardColor  leading-tight focus:outline-none focus:shadow-outline"
                            ...
                            <div className="mb-6">
                              <input
                                ...
                                id="email"
                                placeholder="Email"
                                className="border-[0.5px] border-borderCardColor shadow appearance-none  rounded w-full py-2 px-3 text-white bg-black  leading-tight focus:outline-none focus:shadow-outline"
                                type="email"
                                {...register("email", {
                                  required: {
                                    value: true,
                            ...
                            <div className="mb-6">
                              <input
                                required
                                id="password"
                                className="border-[0.5px] border-borderCardColor mb-2 shadow appearance-none  rounded w-full py-2 px-3 text-white bg-black  leading-tight focus:outline-none focus:shadow-outline"
