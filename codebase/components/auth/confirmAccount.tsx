                    ...
                    <div className="sm:flex sm:items-start">
                      <div className="mt-3 text-center sm:mt-0 w-full sm:text-left">
                        ...
                        <form
                          ...
                          className="bg-cardColorDark bg-cardColorDark border-[0.5px] border-borderCardColor rounded px-8 pt-6 pb-8 mb-4 w-full"
                        >
                          <div className="mb-4">
                          ...
                          <div className="mb-6">
                            <input
                              ...
                              autoComplete="false"
                              id="username"
                              className="shadow appearance-none bg-cardColorDark border-[0.5px] border-borderCardColor rounded w-full py-2 px-3 text-white bg-black  leading-tight focus:outline-none focus:shadow-outline"
                            ...
                            <div>
                              <div className="mb-4">
                                <input
                                  required
                                  id="code"
                                  className=" mb-2 shadow appearance-none bg-cardColorDark border-[0.5px] border-borderCardColor rounded w-full py-2 px-3 text-white bg-black  leading-tight focus:outline-none focus:shadow-outline"
